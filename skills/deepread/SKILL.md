...
# Your webhook receives results when processing completes (typically 2-5 minutes)
```
...
For searchable PDFs, an additional pass creates a searchable PDF output alongside the markdown text.
...
Only if you can't use webhooks, poll every 10-15 seconds:
